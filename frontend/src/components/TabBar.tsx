        ...
        return (
          <button
            ...
            className={cn(
              ...
              isBody ? 'font-km-body text-[13px]' : 'font-km-mono text-[11px] tracking-[0.1em] uppercase',
              isActive ? 'font-semibold text-km-ink' : isBody ? 'font-normal text-km-ink-dim' : 'font-normal text-km-ink-mute',
            )}
          >
            {tab.label}
            {tab.count !== undefined && (
