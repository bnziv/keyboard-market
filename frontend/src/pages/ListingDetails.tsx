        ...
        <div className="grid gap-8 lg:gap-10 grid-cols-1 lg:grid-cols-[1.2fr_1fr]">
                ...
                <>
                  <div className="absolute inset-0 overflow-hidden">
                    <img
                      ...
                      className="object-cover blur-md scale-110 opacity-30 w-full h-full"
                    />
                  </div>
                  <img
                    src={listing.imageUrl}
              ...
              <div className="p-5">
                ...
                {tab === 'shipping' && (
                  <div className="text-sm text-km-ink-dim leading-[1.6]">
                    <p>
                      Shipping details provided by the seller. Contact them for
                      specifics.
                    </p>
                  </div>
                )}
                {tab === 'seller' && (
                  <div className="text-sm text-km-ink-dim leading-[1.6]">
                    <p>
                      Member since{' '}
                      {listing.seller.dateJoined
                        ? formatDate(listing.seller.dateJoined)
                        : 'N/A'}{' '}
          ...
          >
            ...
            <div className="flex gap-2 flex-wrap">
              {[listing.condition && titleCase(listing.condition)]
                .filter(Boolean)
                .map((tag, i) => (
                  <span
                    key={i}
            ...
            <div className="font-km-mono text-xs text-km-ink-mute">
              {listing.createdOn
                ? `Listed ${formatDate(listing.createdOn)}`
                : ''}
            </div>
            ...
            <div className="flex items-center gap-3 p-4 rounded border bg-km-surface-2 border-km-line">
              ...
              <div>
                <div className="text-xs font-medium text-km-ink">
                  Protected purchase
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="font-km-mono text-xs mt-0.5 text-km-ink-mute">
                    {listing.seller.totalListings} listings · joined{' '}
                    {listing.seller.dateJoined
                      ? formatDate(listing.seller.dateJoined)
                      : 'N/A'}
                  </div>
